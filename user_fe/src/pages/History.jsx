...
                        }) : null;
                        ...
                        const displayPrice = entry.discounted_total_price && entry.discounted_total_price > 0
                            ? entry.discounted_total_price
                            : entry.total_price;
...
                                            Total Harga Pesanan: Rp {Number(displayPrice).toLocaleString('id-ID')}
                                        </div>
                                    </div>
                                </div>
...
                                                <th className="px-4 py-3 text-right text-gray-700 font-semibold border-b border-gray-200">Jumlah Pembayaran</th>
