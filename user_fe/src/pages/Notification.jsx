...
const Notification = ({ isOpen, setIsOpen }) => {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      const res = await fetch('https://bbn-web.up.railway.app/api/notification', {
  ...
  const markAsRead = async (id) => {
    ...
    try {
      await fetch(`https://bbn-web.up.railway.app/api/notification/${id}/read`, {
        method: 'POST',
        headers: {
  ...
  const confirmDelivery = async (notif) => {
    ...
    try {
      const res = await fetch(`https://bbn-web.up.railway.app/api/order/${notif.order_id}/confirm-delivery`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
